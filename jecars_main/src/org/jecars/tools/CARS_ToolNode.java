...
public class CARS_ToolNode {
   ...
   * @param pToolNode
   */
  private CARS_ToolNode( final CARS_Main pMain, final Node pToolNode ) throws Exception {
    mTool = CARS_ToolsFactory.getTool( pMain, pToolNode, null );
    return;
  }
   ...
   * @return
   */
  static public CARS_ToolNode newInstance( final CARS_Main pMain, final Node pToolNode ) throws Exception {
    return new CARS_ToolNode( pMain, pToolNode );
  }
...
//       n.save();
      if (n.isLocked()) {
        ...
        final CARS_ToolInterface ti = CARS_ToolsFactory.getTool( main, n, null );
