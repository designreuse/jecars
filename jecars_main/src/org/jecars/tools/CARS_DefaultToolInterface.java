...
//  private ToolThread                        mToolThread = null;
  ...
  static {
    ...
    gExecutorService          = Executors.newFixedThreadPool( ES_COREPOOLSIZE );
...
//            Node ef = em.addEvent( getMain(), null, getTool(), events.getPath(), "TOOL", "OUTPUT", null, "jecars:ToolEvent" );
 ...
 /** Listen to tool instance exceptions, tool instance exceptions are exception which
   ...
   * @param pLevel
   */
  protected void reportException( Throwable pThrow, Level pLevel ) {
    CARS_ToolInstanceEvent tie = CARS_DefaultToolInstanceEvent.createEvent( this, pThrow, pLevel );
