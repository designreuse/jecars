...
//    pMessage.append( "\t\"nodes\": [\n" );
   ...
   */
  @Override
  public void addChildNodeEntry( final CARS_ActionContext pContext, final StringBuilder pMessage, final Node pChildNode, final long pNodeNo ) throws RepositoryException, Exception {
    if (pNodeNo!=1) {
      pMessage.append( "\t,\n" );
    }
