...
public class CARS_OutputGenerator_Atom extends CARS_DefaultOutputGenerator implements CARS_OutputGenerator {
 ...
 /** Create the footer of the message
   ...
   */   
  @Override
  public void addThisNodeEntry( final CARS_ActionContext pContext, final StringBuilder pMessage, final Node pThisNode,
...
//      pMessage.append( "<subtitle>" ).append( CARS_ActionContext.transportString(pThisNode.getProperty( CARS_ActionContext.gDefTitle ).getString())).append( "</subtitle>\n" );
    ...
    pMessage.append( "<author><name>" + CARS_Main.DEFAULTAUTHOR + "</name></author>\n");
    pMessage.append( "<rights>" + CARS_Main.DEFAULTRIGHTS + "</rights>\n");
   ...
   */   
  @Override
  public void addChildNodeEntry( CARS_ActionContext pContext, StringBuilder pMessage, Node pChildNode, long pNodeNo ) throws RepositoryException, Exception {
...
//      }
  ...
  /** Opensearch items
   */
  private void addNodeEntry_opensearch( StringBuilder pMessage, Node pNode, long pFromNode, long pToNode ) {
    if (pFromNode>0) {
  ...
  /** Add node links
   */
  private void addNodeEntry_addlinks( CARS_ActionContext pContext, StringBuilder pMessage, Node pNode ) throws RepositoryException {  
    String path;
...
//      pNode.getSession().checkPermission( pNode.getPath(), "set_property" ); // TODO
  ...
  /** Add node links
   */
  private void addThisNode_addlinks( CARS_ActionContext pContext, StringBuilder pMessage, Node pNode,
