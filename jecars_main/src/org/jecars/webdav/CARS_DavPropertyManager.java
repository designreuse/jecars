...
//        System.out.println("iijdji name " + name + " = " + value );
        query.append( CARS_DefaultMain.DEFAULTNS ).append( name ).append( '=' ).append( value ).append( '&' );
        query.append( CARS_DefaultMain.DEFAULTNS ).append( name + "_NS" ).append( '=' ).append( namespace ).append( '&' );
      } else if (o instanceof DavPropertyName) {
        final DavPropertyName dpn = (DavPropertyName)o;
        final String name  = dpn.getName();
        query.append( CARS_DefaultMain.DEFAULTNS ).append( name ).append( '=' ).append( CARS_DefaultMain.PREFIX_VALUE_REMOVE ).append( '&' );
        query.append( CARS_DefaultMain.DEFAULTNS ).append( name + "_NS" ).append( '=' ).append( CARS_DefaultMain.PREFIX_VALUE_REMOVE ).append( '&' );
