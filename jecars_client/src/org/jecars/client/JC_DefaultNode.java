...
//  static final private JC_Params gDefaultGetNodesParams = JC_Params.createParams();
//  static final private JC_Params gDefaultGetNodeParams  = JC_Params.createParams();
...
//  private boolean                     mHasSynchronized  = false;
...
//    pNode.mHasSynchronized = mHasSynchronized;
   ...
   * @param pParent
   */
  protected void setParent( final JC_Nodeable pParent ) {
    mParentNode = pParent;
    return;
  }
...
//    return (Collection<JC_Propertyable>)mProperties.clone();
   ...
   * @throws org.jecars.client.JC_Exception
   */
  private Collection<JC_Propertyable> getOrCreateProperties() {
    if (mProperties==null) {
   ...
   * @param pPath
   */
  protected void setPath( final String pPath ) {
   ...
   * @param pPath
   */
  protected void setJCPath( final JC_Path pPath ) {
    mPath = pPath;
    return;
  }
...
//    }
   ...
   * @throws org.jecars.client.JC_Exception
   */
  private JC_Propertyable _addProperty( final String pName, final String pValue, final String pType ) throws JC_Exception, UnsupportedEncodingException {      
  ...
  public JC_Propertyable setMultiValuePropertyD( final String pName, final Collection<Double>  pValues) throws JC_Exception {
    JC_MultiValueProperty property = new JC_MultiValueProperty(this);
    property.setName(pName);
   ...
   */
  @Override
  public JC_Nodeable setNodeType( final String pNodeType ) throws JC_Exception {
    mNodeType = pNodeType;
    return this;
  }
...
//          throw JC_HttpException.createErrorHttpException( "Cannot connect to " + pUrl, ce );
    ...
    private void writeNew() throws JC_Exception, IOException {
      ...
      if (mCreateUsingCopy) {
        output.addLinkViaURL( getSourceObjectUrl());
      } else {
        String name;
        Object value;
...
//      populateProperties();
//      getNodes();
//      for (JC_Nodeable node : mChildNodes) {
//        node.refresh();
//      }
      return;
    }
